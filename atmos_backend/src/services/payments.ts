/**
 * ATMOS Payment Service — Dodo Payments Integration
 * ─────────────────────────────────────────────────────
 * Flow:
    ...
    try {
      const res = await fetch(`${DODO_URL}/payment-intents`, {
        ...
        body: JSON.stringify({
          ...
          redirect_url: `${process.env.APP_URL || 'atmos://payment'}/success`,
          cancel_url:   `${process.env.APP_URL || 'atmos://payment'}/cancel`,
